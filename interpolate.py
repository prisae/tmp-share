...
class interp1d(_Interpolator1D):
    ...
    def _call_previousnext(self, x_new):
        ...
        x_new_indices = searchsorted(self.x, x_new, side=self.side)
        ...
        # 4. Reset the once that are exactly spot-on.
        y_new[np.in1d(x_new, self.x)] = self._y[np.in1d(self.x, x_new)]
